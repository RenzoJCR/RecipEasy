...
class CenaFragment : Fragment(), OnRecipeClickListener, SearchableFragment {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_cena, container, false)
        initViews(view)
        loadRecipes()
        return view
    }
    ...
    private fun initViews(view: View) {
        recyclerView = view.findViewById(R.id.recyclerViewCena)
    ...
    private fun loadRecipes() {
        dbHelper?.let { helper ->
            recipeList = helper.getRecipesByCategory(Constants.CATEGORY_CENA)
