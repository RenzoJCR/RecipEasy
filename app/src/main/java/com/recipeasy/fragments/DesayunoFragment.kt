...
class DesayunoFragment : Fragment(), OnRecipeClickListener, SearchableFragment {

    private lateinit var recyclerView: RecyclerView
    private lateinit var recipeAdapter: RecipeAdapter

    // Inicialización perezosa SEGURA con verificación de contexto
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_desayuno, container, false)
        initViews(view)
        loadRecipes()
        return view
    }
    ...
    private fun initViews(view: View) {
        recyclerView = view.findViewById(R.id.recyclerViewDesayuno)
    ...
    private fun loadRecipes() {
        dbHelper?.let { helper ->
            recipeList = helper.getRecipesByCategory(Constants.CATEGORY_DESAYUNO)
