...
class AlmuerzoFragment : Fragment(), OnRecipeClickListener, SearchableFragment {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_almuerzo, container, false)
        initViews(view)
        loadRecipes()
        return view
    }
    ...
    private fun initViews(view: View) {
        recyclerView = view.findViewById(R.id.recyclerViewAlmuerzo)
    ...
    private fun loadRecipes() {
        dbHelper?.let { helper ->
            recipeList = helper.getRecipesByCategory(Constants.CATEGORY_ALMUERZO)
